...
namespace newui {
    ...
    protected:
        ...
        // manual registration needed). Returns nullptr on any failure -
        // unknown class name, an abstract class, or one with no default
        // constructor - same as Class::createInstance() itself already
        // documents (reflection.h).
