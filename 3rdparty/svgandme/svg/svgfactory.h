...
namespace waavs 
{
    ...
    struct SVGFactory
    {
        ...
        {
            return fFeatureNames.findInterned(feature) != nullptr;
        }
        ...
        void registerNodeTypes()
        {
            ...
            // Masking
            SVGMaskAttribute::registerFactory();                // 'mask' attribute
            SVGMaskElement::registerFactory();                // 'mask' element

            SVGFilterAttribute::registerFactory();
