...
namespace newui {
    ...
    SerializationRegistry::SerializationRegistry() {
        ...
        registerTypeOnSelf<ThemedRadioButtonStyle>();
        registerTypeOnSelf<ThemedGroupBoxStyle>();
        registerTypeOnSelf<ThemedToolbarButtonStyle>();
        registerTypeOnSelf<ThemedToolbarDropDownButtonStyle>();
        registerTypeOnSelf<ThemedToolbarDropDownButtonGlyphStyle>();
        registerTypeOnSelf<ThemedToolbarSplitButtonStyle>();
        registerTypeOnSelf<ThemedToolbarSplitButtonDropDownStyle>();
        registerTypeOnSelf<ThemedToolbarSeparatorStyle>();
        registerTypeOnSelf<ThemedStatusPaneStyle>();
        registerTypeOnSelf<ThemedRebarBandStyle>();
        registerTypeOnSelf<ThemedRebarChevronStyle>();
        registerTypeOnSelf<ThemedTooltipStyle>();
        registerTypeOnSelf<ThemedSpinButtonStyle>();
        registerTypeOnSelf<ThemedEditStyle>();
        registerTypeOnSelf<ThemedListItemStyle>();
        registerTypeOnSelf<ThemedHeaderItemStyle>();
        registerTypeOnSelf<ThemedHeaderSortArrowStyle>();
        registerTypeOnSelf<ThemedTreeItemStyle>();
        registerTypeOnSelf<ThemedTreeGlyphStyle>();
        registerTypeOnSelf<ThemedTabItemStyle>();
        ...
        registerTypeOnSelf<ThemedMenuBarItemStyle>();
        registerTypeOnSelf<ThemedMenuBarBackgroundStyle>();
